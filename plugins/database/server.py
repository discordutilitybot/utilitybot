...
class Server(object):
    def __init__(self, server_id: int, server_messages: int, server_name: str, server_joined_at: datetime = datetime.utcnow()):
    ...
    async def post(self):
        ...
        if assure_server == 0:
            query = "INSERT INTO servers ( server_id, server_messages, server_names, server_joined_at ) VALUES ( $1, $2, $3, $4 )"
